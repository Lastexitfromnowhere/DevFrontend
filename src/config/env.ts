export const config = {
  API_BASE_URL: `${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'https://lastexitvpn.duckdns.org'}`, // URL de base sans /api
  DHT_API_URL: `${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'https://lastexitvpn.duckdns.org'}`, // URL de base à laquelle /dht sera ajouté dans dhtUtils.js
