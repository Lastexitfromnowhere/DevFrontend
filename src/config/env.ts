export const config = {
  ...
  DHT_API_URL: `${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'https://lastexitvpn.duckdns.org/api'}/dht`, // URL complète pour le service DHT
