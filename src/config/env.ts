export const config = {
  API_BASE_URL: `${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'http://46.101.36.247:10000'}/api`, // URL de base de l'API backend avec préfixe /api
