  ...
  return (
    <Card className="space-y-4">
      ...
      <div className="text-center p-6 bg-black/20 rounded">
        ...
        <p className="text-sm text-[#8a4d12]-500">Total Earned</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div className="text-center p-2 bg-black/20 rounded">
            ...
            <p className="text-[#8a4d12]-500">Today</p>
            <p className="text-[#8a4d12]-300">{(earnings * 0.1).toFixed(2)} RWRD</p>
          </div>
          <div className="text-center p-2 bg-black/20 rounded">
            <TrendingUp className="mx-auto mb-1 text-green-400" size={16} />
            <p className="text-[#8a4d12]-500">This Week</p>
            <p className="text-[#8a4d12]-300">{(earnings * 0.4).toFixed(2)} RWRD</p>
          </div>
        </div>
      </div>
    </Card>
