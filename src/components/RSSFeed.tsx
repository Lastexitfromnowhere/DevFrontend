...
export default function RSSFeed() {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden min-h-[160px]">
      ...
      />
      <div className="relative bg-black/20 backdrop-blur-sm bg-opacity-30 border border-white/20 shadow-xl rounded-2xl p-8 min-h-[160px] flex flex-col justify-center" style={{boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.18)'}}>
